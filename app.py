...
Highlight the strengths and weaknesses of the applicant in relation to the specified role.
"""
...
your task is to evaluate the resume against the provided job description. give me the percentag
the job description. First the output should come as percentage and then keywords missing a
"""
